...
/*   Updated: 2018/09/18 07:38:56 by xrhoda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc == 1)
	{
		...
		if (init_param(p))
		{
			...
			sphere1 = sphere_new((t_vec3){0, 1, 0}, 1, (t_colour){255, 255, 0}, 0.001);

			sphere2 = sphere_new((t_vec3){0, 100, 0}, 100, (t_colour){0, 0, 255}, 0.001);
			...
			lit = light_new((t_vec3){0, 2, 0}, 0.9, (t_colour){255, 255, 255});
