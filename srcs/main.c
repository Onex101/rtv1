...
/*   Updated: 2018/09/17 08:28:45 by shillebr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc == 1)
	{
		...
		if (init_param(p))
		{
			...
			sphere1 = sphere_new((t_vec3){0, -1, -2}, 1, (t_colour){255, 255, 0}, 0.001);
			...
			lit = light_new((t_vec3){1, 2, -4}, 0.5, (t_colour){255, 255, 255});
