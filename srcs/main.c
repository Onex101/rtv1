...
/*   Updated: 2018/09/14 13:59:56 by shillebr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc == 1)
	{
		...
		if (init_param(p))
		{
			...
			// sphere1 = sphere_new((t_vec3){0, -1, -2}, 0.2, (t_colour){1, 1, 0}, 0.1);
			sphere1 = sphere_new((t_vec3){0, -1, -2}, 0.2, (t_colour){255, 255, 0}, 0.1);
			...
			// lit = light_new((t_vec3){1, -4, -4}, 0.5, (t_colour){1, 1, 1});
			lit = light_new((t_vec3){1, -4, -4}, 0.5, (t_colour){255, 255, 255});
