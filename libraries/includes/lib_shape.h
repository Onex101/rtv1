...
/*   Updated: 2018/09/25 18:21:11 by xrhoda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef int		(*intercept)(t_shape *shape, t_inter *inter);
typedef int		(*rayc)(t_shape *shape, t_ray ray);
typedef	t_vec3	(*normal)(t_shape *shape, t_vec3 hit_pnt);
...
t_shape			cyl_new(t_vec3 p, t_vec3 n, t_colour c, double rad, double tex);
